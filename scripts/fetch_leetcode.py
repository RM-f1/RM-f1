...
NOTE: no timestamp is written to the output on purpose. The file must only
change when a real value changes, otherwise the auto-commit step commits
every day and creates green squares on days without practice.
"""
...
OUTPUT_PATH = "data/leetcode.json"
